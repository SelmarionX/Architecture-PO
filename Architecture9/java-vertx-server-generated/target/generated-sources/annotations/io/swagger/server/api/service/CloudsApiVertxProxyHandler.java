...
import io.swagger.server.api.service.CloudsApi;
...
public class CloudsApiVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 
  private final Vertx vertx;
  private final CloudsApi service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;
  private final boolean includeDebugInfo;

  public CloudsApiVertxProxyHandler(Vertx vertx, CloudsApi service){
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public CloudsApiVertxProxyHandler(Vertx vertx, CloudsApi service, long timeoutInSecond){
    this(vertx, service, true, timeoutInSecond);
  }

  public CloudsApiVertxProxyHandler(Vertx vertx, CloudsApi service, boolean topLevel, long timeoutInSecond){
    this(vertx, service, true, timeoutInSecond, false);
  }

  public CloudsApiVertxProxyHandler(Vertx vertx, CloudsApi service, boolean topLevel, long timeoutSeconds, boolean includeDebugInfo) {
      this.vertx = vertx;
