...
public class _Verticle extends AbstractVerticle {
    static final Logger LOGGER = LoggerFactory.getLogger(_Verticle.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
      ...
      return server.listen()
          .onSuccess(server -> LOGGER.info("_Verticle started on port " + server.actualPort()));
      })
